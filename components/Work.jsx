              ...
              >
                ...
                >
                  <div className="mt-[23px] text-center">
                    <h2 className="font-bold text-lg text-gray-900 dark:text-white mb-2">Project Details</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-6 px-4">This is a sample project description. It highlights the main features and technologies used in the project, providing a quick overview for visitors.</p>
                  </div>
